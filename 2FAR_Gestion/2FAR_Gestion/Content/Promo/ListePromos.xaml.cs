...
namespace _2FAR_Gestion
{
    public partial class ListePromos
    {
        ...
        {
            if (MessageBox.Show("Étes-Vous sur de vouloir supprimer cette promo", "Vérification", MessageBoxButton.OKCancel) == MessageBoxResult.OK)
            {
        ...
        {
            Application.Current.MainWindow.Content = new MenuNavbar(new CreationPromo());
        }
    }
}
